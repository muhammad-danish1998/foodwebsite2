import {
  ...
  GET_ADD_TO_CART_MENU_ITEM_FAIL,
...
const menuReducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case CHECK_OUT_PAYLOAD_DATA:
      return {
        ...state,
        checkoutPayloadData: action.payload,
        loading: false,
      };
    ...
    case GET_REVIEW_DATA:
      return {
        ...state,
        submitReviewData: action.payload,
      };
