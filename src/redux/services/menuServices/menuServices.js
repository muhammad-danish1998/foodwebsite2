...
export const getAddonsMenu = (menu_id) => {
  ...
  return new Promise((resolve, reject) => {
    const endpoint = axiosUrl(
      `/ajax/_api_ajax_get_menu.php?menu_id=${menu_id}`
    );
...
export const getLoadMoreMenu = (id, option) => {
  const token = localStorage.getItem("jwt_token");

  return new Promise((resolve, reject) => {
    const endpoint = axiosUrl(
      `/ajax/_api_ajax_load_addons.php?menu=${id}&option=${option}`
    );
    ...
    axios
      ...
      .then((res) => {
        resolve(res.data);
        console.log("RECEIVED UPDATED MENU", res.data);
      })
      .catch((error) => {
        reject(error.response);
      });
...
export const changePassword = (state) => {
  return new Promise((resolve, reject) => {
    const endpoint = axiosUrl("/_api_ajax-change-password.php");
...
export const resetPassword = (state) => {
  return new Promise((resolve, reject) => {
    const endpoint = axiosUrl("/_api_ajax_reset-password.php");
...
export const getCartItemList = (mode, sessionid) => {
  ...
  return new Promise((ressolve, reject) => {
    const endpoint = axiosUrl(
      `/ajax/_api_ajax_get_cart.php?action=checkout&shipping=${mode}&sessid=${sessionid}`
    );
...
export const getDeleiveryTime = (sessionid) => {
  ...
  return new Promise((ressolve, reject) => {
    const endpoint = axiosUrl(
      `/ajax/__other_apis.php?action=getasaplist&sessid=${sessionid}`
    );
