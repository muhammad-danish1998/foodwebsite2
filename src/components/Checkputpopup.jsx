      ...
      <div className="fixed  inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center  p-4 text-center sm:items-center sm:p-0">
          <Dialog.Panel className="relative border-2 w-full  transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
            ...
            <div className="mt-5   scroll border-black   lg:justify-between ">
            ...
            <div className="flex mt-4 justify-between">
              <button
                onClick={() => setCheckOutModal(false)}
                className="bg-red-600 p-2 mt-2 text-white"
              >
                Go to Menu
              </button>
              <Link to={"/checkout"} className="bg-red-600 p-2 mt-2 text-white">
                Checkout
              </Link>
            </div>
          </Dialog.Panel>
