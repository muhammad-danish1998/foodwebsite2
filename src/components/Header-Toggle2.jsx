...
const HeaderToggle2 = (props) => {
  ...
  return (
    ...
    >
      <label
        htmlFor="Toggle3"
        className="inline-flex items-center  rounded-md cursor-pointer text-black "
      >
        <input
        ...
        />
        <span
          className="px-5  py-2 flex items-center justify-center  mt-2 rounded-l-md text-lg bg-black h-8 text-white peer-checked:bg-gray-300"
          style={{
            width: "120px",
            height: "40px",
            borderRadius: "50px",
        ...
        <span
          ...
          className="px-5 py-2 flex items-center justify-center mt-2 rounded-r-md text-lg bg-gray-300 h-8 peer-checked:text-white peer-checked:bg-black"
        >
          {props.value2}
        </span>
      </label>
