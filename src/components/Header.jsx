...
export const userNavigation = [
  ...
  // { name: "address", href: "/editmyaddress" },
  { name: "reviews", href: "/myreview" },
...
export default function Header() {
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then((data) => {
        if (data.status === "OK") {
          console.log(data, "complete data of api for storing");
    ...
    axios
      ...
      .then((response) => {
        console.log(response, "response for zip code");
                ...
                >
                  ...
                  <div className="w-[100%] flex flex-row justify-between rounded-2xl shadow-sm p-2  items-center  bg-white border-orange-500 ">
                    ...
                    {/* <svg
                      ...
                      onClick={() => {
                        let data = {
                          zipCode: localStorage.getItem("your_zip"),
